                ...
                VStack {
                    ...
                    case .loaded:
                        if let healthData {
                            ...
                            .onAppear {
                                grpcViewModel.updateExistingPlant(with: viewModel.id!, name: viewModel.name, lastWatered: nil, lastHealthCheck: Int64(Date().timeIntervalSince1970), lastIdentification: nil, identifiedSpeciesName: nil, newHealthProbability: nil)
                            }
